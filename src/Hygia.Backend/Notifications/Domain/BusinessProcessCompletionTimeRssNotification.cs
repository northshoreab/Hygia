...
{
    public class BusinessProcessCompletionTimeRssNotification : Notification
    {
        public BusinessProcessCompletionTimeRssNotification(string messageStartType, string messageEndType, string ProcessName, TimeSpan warningLevel)
        {
