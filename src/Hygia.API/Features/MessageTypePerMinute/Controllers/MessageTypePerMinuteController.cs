...
using System.Linq;
using Hygia.API.Features.MessageTypePerMinute.Domain;
using Hygia.API.Features.MessageTypePerMinute.Models;
using Hygia.API.Features.Tests.Testdata;
using Newtonsoft.Json;
using Raven.Client;

namespace Hygia.API.Features.MessageTypePerMinute.Controllers
{
