...
namespace Hygia.Notifications.Summary.Saga
{
                               ...
                               IAmStartedByMessages<ProcessSLABreachMessageReceived>
    {
        ...
        {
            Data.WriteInfo(string.Format("ProcessFaultMessageReceived arrived. MessageId: {0}", message.MessageDetails.MessageId));
            ...
            // Add to the list
            var alertInfo = new AlertInfo { TimeOfAlert = message.MessageDetails.TimeOfFailure, Id = message.MessageDetails.MessageId, NumberOfTimesAlerted = 0 };
